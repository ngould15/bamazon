...
function start() {
    connection.query('SELECT * FROM Products', function (err, res) {
        ...
        //Prompt user for the item id/quantity they would like to purchase
        console.log(' ');
        inquirer.prompt([
            {
                type: "input",
            ...
            //Verify if the quantity is sufficient
            if (res[whatToBuy].StockQuantity >= howMuchToBuy) {
                ...
                //if quantity is not enough, notify customer
            } else {
...
//After customer verifies first item ask if they would like to purchase another item
function reprompt() {
    inquirer.prompt([{
        type: "confirm",
        name: "reply",
